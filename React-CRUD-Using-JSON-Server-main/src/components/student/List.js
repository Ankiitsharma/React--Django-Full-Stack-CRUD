...
const List = () => {
    ...
    useEffect(() => {
        ...
        async function getAllStudent() {
            try {
                const students = await axios.get("http://127.0.0.1:8000/api/apis/")
    ...
    const handleDeelete = async id => {
        await axios.delete(`http://127.0.0.1:8000/api/apis/${id}`);
                                    ...
                                    <TableRow key={i}>
                                        ...
                                        <TableCell align='center'>
                                            ...
                                            <Tooltip title='Delete'>
                                                <IconButton onClick={() => handleDeelete(student.id)}><DeleteIcon color='secondary' /></IconButton>
                                            </Tooltip>
                                        </TableCell>
                                    </TableRow>
